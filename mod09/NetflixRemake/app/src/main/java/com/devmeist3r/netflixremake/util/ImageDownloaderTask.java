package com.devmeist3r.netflixremake.util;
...
import com.devmeist3r.netflixremake.R;
...
/**
 * Created by Lucas Inocencio on 29/03/2021
 */
    ...
    if (imageView != null && bitmap != null) {
      ...
      if (shadowEnabled) {
        LayerDrawable drawable =
            (LayerDrawable) ContextCompat.getDrawable(imageView.getContext(), R.drawable.shadows);
